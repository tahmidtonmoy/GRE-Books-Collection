...
public class MakeVideoList {
	...
	public static void createMyAlbums(){
		...
		createCategoryForPDF("GRE BOOK PART 01", R.drawable.i1, "p1.pdf");
		//==========================================================================*

		//===========================Category for PDF Viewer
		createCategoryForPDF("GRE BOOK PART 01", R.drawable.i2, "p2.pdf");
		//==========================================================================*



		//===========================Category for PDF Viewer
		createCategoryForPDF("GRE BOOK PART 01", R.drawable.i3, "");
		//==========================================================================*


		//===========================Category for PDF Viewer
		createCategoryForPDF("GRE BOOK PART 01", R.drawable.i4, "");
		//==========================================================================*
